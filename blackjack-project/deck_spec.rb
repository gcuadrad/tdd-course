...
RSpec.describe Deck do
  ...
  it 'pop off the stack when a card is dealt' do
    # shuffle the deck, dealt card will be last card that needs to be popped off
    # expect deal_card to equal to dealt card
    dealt_card = @deck.shuffle.last
    expect(@deck.deal_card).to eq(dealt_card)
  end

  it 'dealt card can not be nil' do
